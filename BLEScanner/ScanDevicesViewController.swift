...
class ScanDevicesViewController : UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate, UITableViewDelegate, UITableViewDataSource{
    ...
    func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        ...
        let connectedViewController = storyboard.instantiateViewController(withIdentifier: "ConnectedViewController") as! ConnectedViewController
        
        connectedViewController.peripheral = peripheral
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
        ...
        for characteristic in characteristics {
            ...
            //peripheralManager.updateValue(data as Data, for: characteristic as! CBMutableCharacteristic, onSubscribedCentrals: nil)
            print("DATA PRINT HO RAHA HAI")
            print(data)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! ScanDevicesTableViewCell
